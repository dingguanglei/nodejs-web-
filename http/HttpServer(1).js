module.exports = (function(){
    ...
    return {
        ...
        processRequest:function(request,response){
            ...
            //到此urlk获取完成—————————————————————————————
            var rdata  =  url.parse(requestUrl,true).query;   //获取参数
            var name=rdata.name;
            if(name){
                console.log(JSON.stringify(rdata));
                //console.log(JSON.parse(JSON.stringify(rdata)));
                //response.json(rdata);
            ...
            fs.exists(filePath,function(exists){
                if(exists){
                    ...
                    if(hasExt){
                        ...
                        response.writeHead(200, {"content-type": "text/html","Access-Control-Allow-Origin":"http://localhost"});
                        response.end(html);
                    }
                }
            });
